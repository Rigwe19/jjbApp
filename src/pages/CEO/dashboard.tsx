...
import { IonContent, IonPage, IonButton, IonCard, IonCardContent, IonDatetime, IonIcon, IonInput, IonItem, IonLabel, IonModal, IonNote, IonRefresher, IonRefresherContent, IonSelect, IonSelectOption, DatetimeChangeEventDetail, RefresherEventDetail, useIonLoading, IonAlert } from '@ionic/react';
    ...
    return (
        <IonPage>
            ...
            <IonContent className="ion-padding">
                ...
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Factory Workers Salary</IonLabel>
                    <IonNote slot="end">₦{profit.direct}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
                ...
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Admin Salary</IonLabel>
                    <IonNote slot="end">₦{profit.adminSalary}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Admin Total</IonLabel>
                    <IonNote slot="end">₦{profit.adminTotal}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
