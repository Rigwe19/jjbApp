...
import { DatetimeChangeEventDetail, IonButton, IonCard, IonCardContent, IonContent, IonDatetime, IonIcon, IonInput, IonItem, IonLabel, IonModal, IonNote, IonPage, IonSelect, IonSelectOption, useIonLoading } from '@ionic/react';
...
const CeoCostProduction: React.FC = () => {
    ...
    useEffect(() => {
        ...
        Http.request({
            method: "GET",
            url: href + "/api/ceo/get/costproduction",
            headers: {
    ...
    const handleSearch = () => {
        ...
        Http.request({
            method: "POST",
            url: href + "/api/ceo/search/costproduction",
            headers: {
                'Content-Type': 'application/json',
                'Data-Type': 'json',
                'Authorization': 'Bearer ' + user.token
    ...
    return (
        <IonPage>
            <Toolbar title="Cost of Production" />
            <IonContent className="ion-padding">
                ...
                <IonItem className='mb-1' fill='solid'>
                    ...
                    <IonNote slot="end">₦{profit.opening}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Purchase</IonLabel>
                    <IonNote slot="end">₦{profit.purchase}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Total Stock</IonLabel>
                    <IonNote slot="end">₦{profit.total}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Less Closing Balance</IonLabel>
                    <IonNote slot="end">₦{profit.closing}</IonNote>
                </IonItem>
                <IonItem className='mb-1' fill='solid'>
                    <IonLabel>Cost of Sale/Direct Cost</IonLabel>
                    <IonNote slot="end">₦{profit.sale}</IonNote>
                </IonItem>
            </IonContent>
        </IonPage>
    );
...
export default CeoCostProduction;