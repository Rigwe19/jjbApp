...
const CeoDispatch: React.FC = () => {
    ...
    useEffect(() => {
        ...
        Http.request({
            method: "GET",
            url: href + "/api/ceo/get/dispatches",
            headers: {
    ...
    const handleSearch = () => {
        ...
        Http.request({
            method: "POST",
            url: href + "/api/ceo/search/dispatches",
            headers: {
                'Content-Type': 'application/json',
                'Data-Type': 'json',
                'Authorization': 'Bearer ' + user.token
    ...
    return (
        <IonPage>
            ...
            <IonContent className="ion-padding">
                ...
                {dispatches.length > 0 && <table className='ledger-tb'>
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Shift</th>
                ...
                {dispatches.length === 0 && <div className="w-full h-full -z-10 absolute top-0 flex flex-col justify-center items-center">
                    <IonIcon color="medium" size="large" icon={closeCircleOutline} />
                    <IonLabel color="medium">No Dispatches Found</IonLabel>
                </div>}
